...
public class EmployeeDao {
	...
	public void batchUpdate()
	{
		...
		try {
			st = con.createStatement();
			st.addBatch("update mphemp set ename ='ram' where eid=1");
			st.addBatch("update mphemp set eid=2 where ename ='Afeed'");
			st.addBatch("update mphemp set ename ='saiii' where eid=3");
